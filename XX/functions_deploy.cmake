...
function(set_device_screen_name NAME)
   if(IOS)      
      #set_target_properties(${PROJECT_NAME} PROPERTIES MACOSX_BUNDLE_BUNDLE_NAME ${NAME})
   elseif(ANDROID)
      set_target_properties(${PROJECT_NAME} PROPERTIES QT_ANDROID_APP_NAME ${NAME})
   endif()
endfunction()