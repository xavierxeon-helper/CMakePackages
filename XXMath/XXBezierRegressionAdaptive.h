...
namespace XX
{
   namespace Bezier
   {
      ...
      private:
         ...
         Curve generateBezier(const Chord& chord, const QVector<double>& u, const Linalg::Vector3& tangent1, const Linalg::Vector3& tangent2) const;
         ...
         QVector<Linalg::Vector3> fitCubic(const Chord& chord, Linalg::Vector3 tangent1, Linalg::Vector3 tangent2) const;
