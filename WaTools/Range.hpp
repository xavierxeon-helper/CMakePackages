...
inline Range::Mapper::Mapper(const float& minInput, const float& maxInput, const float& minOutput, const float& maxOutput)
   : minInput(minInput)
   , maxInput(maxInput)
   , minOutput(minOutput)
   , maxOutput(maxOutput)
...
inline void Range::Mapper::setMinInput(const float& value)
{
   if (value < maxInput)
   {
      minInput = value;
...
inline void Range::Mapper::setMaxInput(const float& value)
{
   if (value > minInput)
   {
      maxInput = value;
...
inline void Range::Mapper::setMinOutput(const float& value)
{
   minOutput = value;
   updateScale();
}

inline void Range::Mapper::setMaxOutput(const float& value)
{
   maxOutput = value;
   updateScale();
}

inline void Range::Mapper::updateScale()
{
...
inline float Range::Mapper::operator()(const float& input) const
{
   if (input <= minInput)
      return minOutput;
   if (input >= maxInput)
