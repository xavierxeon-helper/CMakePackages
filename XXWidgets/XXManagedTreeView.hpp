...
void XX::Managed::TreeView::onSelected(TargetClass* instance, void (TargetClass::*memberFunction)(QStandardItem*))
{
   selectedFunction = std::bind(memberFunction, instance, std::placeholders::_1);
}

template <typename TargetClass>
void XX::Managed::TreeView::onDoubleClicked(TargetClass* instance, bool (TargetClass::*memberFunction)(QStandardItem*))
{
   doubleClickFunction = std::bind(memberFunction, instance, std::placeholders::_1);
}

template <typename TargetClass>
void XX::Managed::TreeView::onContextMenu(TargetClass* instance, QMenu* (TargetClass::*memberFunction)(QStandardItem*))
{
